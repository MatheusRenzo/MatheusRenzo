...
<h3 align="center">Desenvolvedor Full Stack | Python | Node.js | TypeScript | JavaScript | Nest.js | React.js | Next.js | Angular | GraphQL | PostgreSQL | MySQL | Git | VTEX</h3>
...
Atuei na manutenção e suporte de VPS (Servidores Privados Virtuais) da APS Tecnologia e da plataforma CloudIce, garantindo alta disponibilidade, estabilidade e desempenho contínuo das aplicações hospedadas. Fui responsável por identificar e solucionar incidentes técnicos, minimizando o tempo de inatividade e assegurando uma operação fluida para clientes e usuários.  
Principais conquistas:

  Desenvolvi e configurei servidores de jogos online, como Priston Tale e GTA RP, em plataformas abertas. Realizei ajustes de performance, personalização e monitoramento, proporcionando uma experiência estável e otimizada para os jogadores.  
  Trabalhei em conjunto com a equipe para otimizar a infraestrutura dos servidores, assegurando o uso eficiente de recursos de CPU, memória e armazenamento.  
...
![GitHub Commits](https://githubstats.com.br/api/stats?username=MatheusRenzo&theme=prussian&showBorder=true&language=pt&type=commits&days=30)
